...
#            "crit": spike_chance,
            ...
            "name":f'osnds_station_{station_number}'
        }
    ]
    ...
    mqtt_ext.publish(f'osnds/livestream/station/{station_number}/acceleration/',msg,qos=1)  #publish the data to the remote mqtt server
